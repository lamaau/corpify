...
<template>
    <BasicPage
        title="Work Program"
        description="This show all of your work program"
        sticky
    >
        <template #actions>
            <Button @click="$router.push({ name: 'work-program.create' })">
                Add New
                <PlusIcon />
            </Button>
        </template>
        <div class="w-[calc(100svw-2rem)] md:w-full overflow-x-auto">
            <DataTable ref="tableRef" url="/work-programs" :columns="columns">
